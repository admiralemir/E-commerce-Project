          ...
          <div className="grid md:grid-cols-2 gap-8 items-center py-16 md:py-24">
            <div className="space-y-6">
              ...
              <div className="flex gap-4 pt-4">
                ...
                <Link
                  href="/wishlist"
                  className="px-8 py-3.5 border-2 border-black text-black font-semibold uppercase tracking-wider hover:bg-black hover:text-white transition-all flex items-center gap-2"
                >
