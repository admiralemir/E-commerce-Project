                            ...
                            {products.map((product) => (
                                <div key={product.slug} className="group">
                                    ...
                                    <button 
                                        ...
                                        className="absolute top-3 right-3 w-10 h-10 bg-white rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity shadow-lg hover:bg-black hover:text-white"
                                    >
                                        <svg 
